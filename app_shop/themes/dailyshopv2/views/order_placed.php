    ...
    <div class="aa-catg-head-banner-area">
     <div class="container">
      <div class="aa-catg-head-banner-content">
        ...
        <ol class="breadcrumb">                 
          <li><a href="#"><?php echo lang('form_checkout');?> &raquo; <?php echo lang('order_details');?></a></li>
        </ol>
      </div>
     </div>
   </div>
...
<div class="row">
	<div class="col-xs-4">
		<h3><a href="#" class="btn btn-success"><?php echo lang('account_information');?></a></h3>
	...
	?>
	<div class="col-xs-4">
		<h3><a href="#" class="btn btn-success"><?php echo ($ship != $bill)?lang('shipping_information'):lang('shipping_and_billing');?></a></h3>
	...
	<?php if($ship != $bill):?>
	<div class="col-xs-4">
		<h3><a href="#" class="btn btn-success"><?php echo lang('billing_information');?></a></h3>
...
<div class="row">
	<div class="col-xs-4">
		<h3><a href="#" class="btn btn-info"><?php echo lang('additional_details');?></a></h3>
		<?php
	...
	<div class="col-xs-4">
		<h3 style="padding-top:10px;"><a href="#" class="btn btn-warning"><?php echo lang('shipping_method');?></a></h3>
		<?php echo $shipping['method']; ?>
	</div>
	
	<div class="col-xs-4">
		<h3><a href="#" class="btn btn-warning"><?php echo lang('payment_information');?></a></h3>
