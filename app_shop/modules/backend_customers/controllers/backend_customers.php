 ...
 * Index of function :
 -----------------------------------------------------------------
 	1. Function customers home
	2. Function customers form
	3. Function customers delete
	4. Function customers address
		---- 4.1 Function address home
		---- 4.2 Function address list
		---- 4.3 Function address form
		---- 4.3 Function address delete
	5. Function customers group
		---- 5.1 Function customers group home
		---- 5.2 Function customers group edit
		---- 5.3 Function customers get group
		---- 5.4 Function customers delete group
	6. Function customers check email
	7. Function customers get order list
	8. Function customers get subscriber list
	9. Function customers export to xml
 =================================================================
*/

class Backend_customers extends Admin_Controller {
	...
	function index($field='lastname', $by='ASC', $page=0)
	{
		...
		$config['base_url']			= base_url().'/'.'backend_customers/index/'.$field.'/'.$by.'/';
		...
		$data['content'] = 'backend_customers';
	...
	function form($id = false)
	{
		...
		{
			$data['content'] = 'backend_customer_form';
			$this->load->view($this->template, $data);
		}
		else
		{
	...
	/*===================================================================
 	...
 	=====================================================================*/
		...
		function addresses($id = false)
		{
			...
			$data['content'] = 'backend_customer_addresses';
			$this->load->view($this->template, $data);
		}
		/*---------------------------------------------------------------
		 4.2 Function address list
		...
		function address_list($customer_id)
		{
			...
			$data['content'] = 'backend_address_list';
			$this->load->view($this->template, $data);
		}
		/*---------------------------------------------------------------
		 4.3 Function address form
		...
		function address_form($customer_id, $id = false)
		{
			...
			if ($this->form_validation->run() == FALSE)
			{
				$data['content'] = 'backend_customer_address_form';
				$this->load->view($this->template, $data);
			}
			else
			{
				...
				redirect('backend_customers/addresses/'.$customer_id);
			}
		}
		/*---------------------------------------------------------------
		 4.4 Function address delete
		-----------------------------------------------------------------*/
	...
	/*===================================================================
 	...
 	=====================================================================*/
		...
		function groups()
		{
			...
			$data['content'] = 'backend_customer_groups';
			$this->load->view($this->template, $data);
		}
		/*---------------------------------------------------------------
		 5.2 Function customers group edit
		...
		function edit_group($id=0)
		{
			...
			if ($this->form_validation->run() == FALSE)
			{
				$data['content'] = 'backend_customer_group_form';
				$this->load->view($this->template, $data);
			}
			else
			{
				...
				redirect('backend_customers/groups');
			}
		}
		/*---------------------------------------------------------------
		 5.3 Function customers get group 
		...
		/*---------------------------------------------------------------
		 5.4 Function customers group delete
		-----------------------------------------------------------------*/
	...
	function order_list($status = false)
	{
		...
		$data['content'] = 'backend_customer_order_list';
		$this->load->view($this->template, $data);
	}
	...
	function get_subscriber_list()
	{
		...
		$data['content'] = 'backend_customer_subscriber_list';
		$this->load->view($this->template, $data);
	}	
	...
	function export_xml()
	{
		...
		force_download_content('customers.xml',	$this->load->view('backend_customers_xml', $data, true));
	}
}
