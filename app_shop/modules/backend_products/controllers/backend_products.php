 ...
 * Index of function :
 -----------------------------------------------------------------
 	1. Function products home
	2. Function products search 
	3. Function products bulk save
	4. Function products form
	5. Function products image form
	6. Function products image upload
	7. Function products delete
 =================================================================
*/

class Backend_products extends Admin_Controller {	
	...
	function index($order_by="name", $sort_order="ASC", $code=0, $page=0, $rows=15)
	{
		...
		$config['base_url']			= site_url('backend_products/index/'.$order_by.'/'.$sort_order.'/'.$code.'/');
	...
	function form($id = false, $duplicate = false)
	{
		...
		*/
		...
		{
			$data['content'] = 'backend_product_form';
			$this->load->view($this->template, $data);
		}
		else
		{
	...
	function product_image_form()
	{
		...
		//$data['content'] = 'backend_product_image_uploader';
		$this->load->view('backend_products/iframe/product_image_uploader', $data);
	}
