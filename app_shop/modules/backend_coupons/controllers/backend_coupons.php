 ...
 * Index of function :
 -----------------------------------------------------------------
 	1. Function coupons home
	2. Function coupons form
	3. Function coupons check code validation
	4. Function coupons delete
 =================================================================
*/

class Backend_coupons extends Admin_Controller {	
	...
	function form($id = false)
	{
		...
		{
			$data['content'] = 'backend_coupon_form';
			$this->load->view($this->template, $data);
		}
		else
		{
