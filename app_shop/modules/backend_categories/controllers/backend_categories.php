 ...
 * Index of function :
 -----------------------------------------------------------------
 	1. Function categories home
	2. Function categories organize
	3. Function categories organize proccess
	4. Function categories form
	5. Function categories delete
 =================================================================
*/

class Backend_categories extends Admin_Controller { 
    ...
    function index()
    {
		...
		$data['content'] = 'backend_categories';
    ...
    function organize($id = false)
    {
		...
		$data['content'] = 'backend_organize_category';
        $this->load->view($this->template, $data);
    }
    ...
    function form($id = false)
    {
        ...
        {
			$data['content'] = 'backend_category_form';
			$this->load->view($this->template, $data);
        }
        else
        {
