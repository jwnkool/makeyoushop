 ...
 * Index of function :
 -----------------------------------------------------------------
 	1. Function index 404 page
	2. Function login
	3. Function logout
	4. Function register
	5. Function check email validate
	6. Function forgot password
	7. Function view my account
	8. Function view my download digital product
	9. Function download link
   10. Function set default address
   11. Function address form
   12. Function delete address
 =================================================================
*/
	...
	function register()
	{
		...
		*/
		...
		else
		{
			...
			$row['content_messages'] = str_replace('{customer_name}', $this->input->post('firstname').' '. $this->input->post('lastname'), $row['content_messages']);
			...
			$this->email->message(html_entity_decode($row['content_messages']));
