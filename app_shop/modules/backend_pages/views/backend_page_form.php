<!-- Content Header (Page header) -->
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><?php echo lang('page_form') ?></li>
                    </ol>
                </section>
                ...
                <section class="content">
					...
					<?php echo form_open('backend_pages/form/'.$id); ?>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="content_tab">
                                <fieldset>
                                    ...
                                    <?php
                                    $data	= array('name'=>'content_pages', 'class'=>'redactor', 'value'=>set_value('content_pages', $content_pages));
