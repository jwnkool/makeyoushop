...
class kurir_toko
{
	...
	function rates()
	{
		...
		$settings	= $this->CI->Settings_model->get_settings('kurir_toko');
	...
	function install()
	{
		...
		$this->CI->Settings_model->save_settings('kurir_toko', $install);
	}
	
	function uninstall()
	{
		$this->CI->Settings_model->delete_settings('kurir_toko');
	}
	...
	{ 
		...
		return $this->CI->load->view('kurir_toko_form', $data, true);
	...
	{	
		...
		$this->CI->Settings_model->save_settings('kurir_toko', $save);
